<%@ Page Title="" Language="C#" MasterPageFile="~/AcademiaMasterPage.Master" AutoEventWireup="true" CodeBehind="Cursos.aspx.cs" Inherits="UI.Web.Cursos" %>
            ...
            <div class="panel panel-default panel-login">
                ...
                <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:DropDownList ID="ddlMateria" runat="server" DataSourceID="ObjectDataSourceMaterias" DataTextField="Descripcion" DataValueField="ID"></asp:DropDownList>
                                    <asp:ObjectDataSource ID="ObjectDataSourceMaterias" runat="server" SelectMethod="GetAll" TypeName="Negocio.MateriaLogic"></asp:ObjectDataSource>
                                    <asp:Label ID="lblAsteriscoMateria" CssClass="asteriscoValidation" runat="server" Visible="False" Text="*" ForeColor="Red"></asp:Label>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:Label ID="lblAsteriscoAnioCalendario" CssClass="asteriscoValidation" runat="server" Visible="False" Text="*" ForeColor="Red"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <asp:Label ID="lblAsteriscoCupo" CssClass="asteriscoValidation" runat="server" Visible="False" Text="*" ForeColor="Red"></asp:Label>
                                </div>
                            </div>
